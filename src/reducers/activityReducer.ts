...
export type ActivityActions = 
    {
        type: 'save-activit' /* Una vez hayamos enviado el formulario, ejecutará el type de "save-activity" */,
...
export const activityReducer = (
    ...
    if(action.type === 'save-activit'){ // Una vez que yo mande a llamar, la acción de arriba "save-activity" va a escanear nuestro código y va a buscar ese mismo type para ejecutar ese código.
